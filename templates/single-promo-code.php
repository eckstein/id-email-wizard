				...
				<div class="wizHeaderInnerWrap">
					<div class="wizHeader-left">
						...
						<div class="wizEntry-meta"><strong>Promo Code</strong>&nbsp;&nbsp;&#x2022;&nbsp;&nbsp;Run dates:
							<?php echo date('m/d/Y', strtotime(get_post_meta(get_the_ID(), 'start_date', true))) ?? 'Error: Start date not set!'; ?> - <?php echo get_post_meta(get_the_ID(), 'end_date', true) != '' ? date('m/d/Y', strtotime(get_post_meta(get_the_ID(), 'end_date', true))) : 'Forever'; ?>
							&nbsp;&nbsp;&#x2022;&nbsp;&nbsp;Includes
