...
<div class="wizcampaign-section inset">
    ...
    <div class="wizChartWrapper">
        <canvas class="ctrReport wiz-canvas" data-chartid="ctrReport" data-campaignids='<?php echo json_encode(array_column($campaignsInRange, 'id')); ?>' data-lastYearCampaignIds='<?php echo json_encode(array_column($lastYearCampaigns, 'id')); ?>' data-charttype="line" data-campaignType="blast" data-startdate="<?php echo $startDate; ?>" data-enddate="<?php echo $endDate; ?>" data-cohorts='<?php echo json_encode($selectedCohorts); ?>' data-max-y="3">
        </canvas>
    </div>
</div>
<div class="wizcampaign-section inset">
    ...
    <div class="wizChartWrapper">
        <canvas class="ctoReport wiz-canvas" data-chartid="ctoReport" data-campaignids='<?php echo json_encode(array_column($campaignsInRange, 'id')); ?>' data-lastYearCampaignIds='<?php echo json_encode(array_column($lastYearCampaigns, 'id')); ?>' data-charttype="line" data-campaignType="blast" data-startdate="<?php echo $startDate; ?>" data-enddate="<?php echo $endDate; ?>" data-cohorts='<?php echo json_encode($selectedCohorts); ?>' data-max-y="5">
        </canvas>
    </div>
</div>