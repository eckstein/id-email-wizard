            ...
            <div class="input-groups">
                ...
                <div class="input-group">
                    <select name="purchase_attribution_length" id="selectAttrLength">
                        <option value="allTime" <?php if (!$userAttLength || $userAttLength == 'allTime') { echo ' selected';} ?>>All Time (default)</option>
                        <option value="72Hours" <?php if ($userAttLength == '72Hours') { echo ' selected';} ?>>72 Hours</option>
                        <option value="30Days" <?php if ($userAttLength == '30Days') { echo ' selected';} ?>>30 Days</option>
                        <option value="60Days" <?php if ($userAttLength == '60Days') { echo ' selected';} ?>>60 Days</option>
                        <option value="90Days" <?php if ($userAttLength == '90Days') { echo ' selected';} ?>>90 Days</option>
                    </select>
                </div>
            </div>
                    ...
                    <label>
                        <div class="radio-item">
                            <input <?php if ($userAttMode == 'broad-channel-match') {
                                ...
                                class="purchase-attribution" name="purchase_attribution_mode" value="broad-channel-match">
                            Broad
                            Channel Match
                        </div>
                    ...
                    <label>
                        <div class="radio-item">
                            <input <?php if ($userAttMode == 'email-channel-match') {
                                ...
                                class="purchase-attribution" name="purchase_attribution_mode" value="email-channel-match">
                            Email
                            Channel Match
                        </div>
