                            ...
                            <tr>
                              <td align="center" valign="top" class="container-padding">
                                <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%;max-width:100%;">
                                  <tbody>
                                    <tr>
                                      <td class="text center-text" valign="middle" align="left" style="font-family:Poppins, sans-serif;font-size:18px;line-height:26px;color:#545454 !important;text-decoration:none;">
