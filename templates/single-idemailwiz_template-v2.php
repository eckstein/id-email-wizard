	...
	<div class="right" id="preview" type="text/html">
		...
		<div id="templateActions">
			...
			<div class="innerWrap">
				...
				<a title="Get Template Code" class="wiz-button showFullMode" id="showFullCode" data-preview-mode="code"
					data-postid="<?php echo get_the_id(); ?>"><i class="fa-solid fa-code"></i>&nbsp;&nbsp;Code</a>
				<a title="Show Full Preview" class="wiz-button green showFullMode" id="showFullPreview"
				...
				<div id="deviceSwitcher">
					...
					<i title="Toggle Dark Mode" class="fa-solid fa-circle-half-stroke" id="toggleDarkMode"></i>
		...
		<div id="templatePreview">
			<?php if ( $wizSettings['wysiwyg_builder_version'] == 'v1' ) { ?>
