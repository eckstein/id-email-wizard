<div class="three-col" style="padding-left: 10px; padding-right: 10px;text-align:center;font-size:0;">
    <?php
    $parentChunk = $chunk;
    if (count($parentChunk) === 4) {
        foreach ($parentChunk as $key => $contentField) {
            if (strpos($key, 'field_') === 0) {
                ...
                <tr>
                <td style="width:33.33%;" valign="middle">
                <![endif]-->
                <div class="column" style="width:100%;max-width:267px;display:inline-block;vertical-align:top;">
                    <?php
        ...
        echo "Error: The layout requires exactly three sets of flexible content fields.";
    }
    ?>
</div>