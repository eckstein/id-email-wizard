...
?>
	...
	<![endif]-->
	<div class="chunk id-spacer <?php echo $chunkClasses; ?> <?php echo $visibility['class']; ?>" <?php echo $chunkDataAttr; ?> style="<?php echo $visibility['inlineStyle']; ?>" aria-hidden="true">
		<div style="line-height:<?php echo $spacerHeight; ?>;height:<?php echo $spacerHeight; ?>; font-size: <?php echo $spacerHeight; ?>; <?php echo $backgroundColorCss; ?>">
			&#8202;</div>
	</div>
	<!--[if mso]>
	</td>
...
function idwiz_get_button_chunk($chunk, $templateOptions, $chunkIndex = null, $isEditor = false)
{
	...
	<div class="chunk id-button <?php echo $chunkClasses; ?> <?php echo $visibility['class']; ?>" <?php echo $chunkDataAttr; ?> style="width: 100%; border: 0; border-spacing: 0; <?php echo $visibility['inlineStyle']; ?> <?php echo $backgroundColorCss; ?>">
...
function idwiz_get_raw_html_chunk($chunk, $templateOptions, $chunkIndex = null, $isEditor = false)
{
	...
	<div class="chunk id-plain-text <?php echo $chunkClasses; ?> <?php echo $pPaddingClass; ?> <?php echo $visibility['class']; ?>" <?php echo $chunkDataAttr; ?> style="<?php echo $visibility['inlineStyle']; ?> <?php echo $backgroundColorCss; ?> color: <?php echo $baseTextColor; ?>; padding: <?php echo $chunkPadding; ?>; font-size: <?php echo $templateFontSize; ?>; border:1px solid transparent;">
		<?php
		if ($gmailBlendDesktopClass || $gmailBlendMobileClass) {
			echo '<div class="gmail-blend-screen ' . $gmailBlendDesktopClass . ' ' . $gmailBlendMobileClass . '">';
			echo '<div class="gmail-blend-difference ' . $gmailBlendDesktopClass . ' ' . $gmailBlendMobileClass . '">';
	...
	<table role="presentation" style="width:100%;border:0;border-spacing:0;table-layout:fixed;font-size: 0;">
		<tr>
			<td style="font-size: 0;line-height:0;margin:0;padding:<?php echo $headerPadding; ?>;">
				<a href="https://www.idtech.com" style="margin:0; padding: 0;" aria-label="iD Tech Camps" title="iD Tech Camps">
					<img src="<?php echo $headerLogo; ?>" width="<?php echo $templateStyles['body-and-background']['template_width']; ?>" alt="" style="width:<?php echo $templateStyles['body-and-background']['template_width']; ?>; max-width:100%;height:auto;display: block;" />
				</a>
			</td>
		</tr>
	</table>
...
?>
	...
	<![endif]-->
	<div style="<?php echo $footerBackgroundCss; ?>; max-width: <?php echo $templateStyles['body-and-background']['template_width']; ?>; padding: 20px 0 10px 0; font-size: 12px;font-family:Poppins, Arial, sans-serif; text-align: center;">

		<span style="margin:0;font-family:Poppins,sans-serif;font-size:12px;line-height:16px;">
			<a href="https://www.facebook.com/computercamps" title="iD Tech on Facebook" aria-label="iD Tech on Facebook"><img width="35" alt="iD Tech on Facebook" style="width: 35px;height: auto;" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/669d5713-9b6a-46bb-bd7e-c542cff6dd6a/d290cbad793f433198aa08e5b69a0a3d/e1322b55-a0f4-4246-b530-3a0790a4c361.png" /></a></span>
		&nbsp;
		<span style="margin:0;font-family:Poppins,sans-serif;font-size:12px;line-height:16px;">
			<a href="https://twitter.com/idtechcamps" title="iD Tech on Twitter" aria-label="iD Tech on Twitter"><img width="35" alt="iD Tech on Twitter" style="width: 35px;height: auto;" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/669d5713-9b6a-46bb-bd7e-c542cff6dd6a/d290cbad793f433198aa08e5b69a0a3d/94d22bf5-cc89-43f6-a4d8-8567c4e81d9d.png" /></a></span>
		&nbsp;
		<span style="margin:0;font-family:Poppins,sans-serif;font-size:12px;line-height:16px;">
			<a href="https://www.instagram.com/idtech/" title="iD Tech on Instagram" aria-label="iD Tech on Instagram"><img width="35" alt="iD Tech on Instagram" style="width: 35px;height: auto;" src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/669d5713-9b6a-46bb-bd7e-c542cff6dd6a/d290cbad793f433198aa08e5b69a0a3d/6b969394-7c4c-45c1-9079-7e98dddcbbb2.png" /></a></span>
		<br />
		<?php
		if ($gmailBlendDesktopClass || $gmailBlendMobileClass) {
			echo '<div class="gmail-blend-screen ' . $gmailBlendDesktopClass . ' ' . $gmailBlendMobileClass . '">';
		...
		?>
		<p style="color:<?php echo $footerTextColor; ?>;margin:0;padding: 1em 0;font-family:Poppins,sans-serif;font-size:12px;line-height:16px;">
		...
		<?php if ($showUnsub) { ?>
			<?php echo '{{#if userId}}'; ?>
			<a href="{{hostedUnsubscribeUrl}}" aria-label="Manage Subscription Preferences" title="Manage Subscription Preferences" style="color: <?php echo $footerLinkColor; ?>;">Manage
				preferences</a>
			<br />
			<?php echo '{{/if}}'; ?>

			<a href="{{unsubscribeMessageTypeUrl}}" aria-label="Unsubscribe from emails like this" title="Manage Subscription Preferences" style="color: <?php echo $footerLinkColor; ?>;">Unsubscribe from emails
				like this</a>
			<br />
			<a href="{{unsubscribeUrl}}" aria-label="Unsubscribe from all marketing emails" title="Manage Subscription Preferences" style="color: <?php echo $footerLinkColor; ?>;">Unsubscribe from all
				marketing emails</a>
			<br /><br />
		<?php } ?>
		<?php
...
?>
	...
	<![endif]-->
	<div style="<?php echo $footerBackgroundCss; ?> width: 100%; max-width: <?php echo $templateStyles['body-and-background']['template_width']; ?>; padding-bottom: 20px; font-size: 12px;">
		<?php
...
?>
	...
	<head>
		...
		<style type="text/css">
			u+#body a {
				...
				<?php if ($underlineLinks) { ?>text-decoration: underline;
				<?php } else { ?>text-decoration: none;
				<?php } ?>font-size: inherit;
				font-family: inherit;
				font-weight: inherit;
				line-height: inherit;
			}
		...
		<style type="text/css">
			...
			a[x-apple-data-detectors] {
				...
				<?php if ($underlineLinks) { ?>text-decoration: underline !important;
				<?php } else { ?>text-decoration: none !important;
				<?php } ?>font-size: inherit !important;
	...
	<body class="body" id="body" style="margin: 0; padding: 0; word-spacing: normal;">
		...
		<div role="article" aria-roledescription="email" lang="en" style="-webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; word-spacing:normal;text-align: center;">
			<table role="presentation" style="width: 100%; border: 0; border-spacing: 0;margin: 0 auto; <?php echo $bodyBackgroundCss; ?>" class="email-wrapper">
				<tr>
					<td align="center">
						<!--[if mso]> 
							<table role="presentation" align="center" style="width:<?php echo $templateWidth ?>px; border: 0; border-spacing: 0;margin: 0 auto;"> 
							<tr> 
							<td style="padding:20px 0; <?php echo $pageBackgroundCss; ?>"> 
							<![endif]-->
						<div class="outer" style="width: 100%; max-width: <?php echo $templateWidth ?>px; margin: 20px auto; <?php echo $pageBackgroundCss; ?>">
						<?php
						return ob_get_clean();
					}
