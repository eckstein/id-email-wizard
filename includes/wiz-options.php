...
function idemailwiz_register_settings()
{
    ...
    add_settings_field('triggered_sync_length', 'Days to sync triggered sends', 'idemailwiz_render_text_field', 'idemailwiz_settings', 'idemailwiz_main_section', array('option_name' => 'triggered_sync_length'));
